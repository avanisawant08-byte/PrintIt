                  ...
                  <div key={idx} className="bg-surface-bright border border-outline-variant p-3 rounded-lg flex items-center justify-between gap-4">
                    ...
                    {order.files_deleted ? (
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-primary/15 text-primary hover:bg-primary/25 border border-primary/30 font-semibold rounded text-xs transition-colors flex items-center gap-1.5 shrink-0 cursor-pointer"
                        title="Open print stream preview"
                      >
