      ...
      {Array.from({ length: count }).map((_, i) => (
        ...
        >
          <div className="flex items-center justify-between">
            <div className="h-5 bg-surface-container-highest rounded-md w-1/3"></div>
            <div className="h-6 bg-surface-container-highest rounded-full w-20"></div>
          </div>
          <div className="h-4 bg-surface-container-highest/60 rounded-md w-2/3"></div>
          <div className="h-4 bg-surface-container-highest/40 rounded-md w-1/2"></div>
        </div>
      ))}
